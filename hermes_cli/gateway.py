...
_PLATFORMS = [
    ...
    # nostr moved into a bundled plugin (plugins/platforms/nostr/); its setup
    # surface (requires_env/optional_env + interactive_setup) is registered via
    # the plugin's register() and discovered through the registry. #41112.
    {
        "key": "yuanbao",
        "label": "Yuanbao",
        "emoji": "💎",
...
def _builtin_setup_fn(key: str):
    ...
    return {
        ...
        "qqbot": _setup_qqbot,
        # nostr moved into the plugin: setup_fn registered by
        # plugins/platforms/nostr/adapter.py::register(). #41112.
    }.get(key)
